...
$\Aprx{\mathrm{c}}_{t}$ by interpolating a finite set of
...
optimist and below by the pessimist.
  ...
  \begin{figure}
    ...
    \caption[Moderation Illustrated]{Moderation Illustrated: $\cFuncBelow_{t-1} < \Aprx{\mathrm{c}}_{t-1} < \cFuncAbove_{t-1}$}
